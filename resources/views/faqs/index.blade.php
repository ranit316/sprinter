        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">FAQ
                    </h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                        ...
                        <div id="kt_datatable_example_export_menu" data-kt-menu="true"
                            ...
                            <div class="menu-item px-3">
                                <form id="faq_excel_form" method="POST" action="{{ route('faq.excel.export') }}">
                                    @csrf
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="javascript:void(0);"
                                                    onClick="submit_form('faq_excel_form','all_ids_excell','excel_type');"
                            ...
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <form id="faq_csv_form" method="POST" action="{{ route('faq.csv.export') }}">
                                    @csrf
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="javascript:void(0);"
                                                    onClick="submit_form('faq_csv_form','all_ids_csv','csv_type');"
                            ...
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <form id="faq_pdf_form" method="POST" action="{{ route('faq.pdf.export') }}">
                                    @csrf
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="javascript:void(0);"
                                                    onClick="submit_form('faq_pdf_form','all_ids_pdf','pdf_type');"
                        ...
                        <div class="card card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bold fs-3 mb-1">FAQ</span>
                                        ...
                                        <div class="px-7 py-5">
                                            <form id="searchform" name="searchform">
                                                ...
                                                <div class="d-flex justify-content-end">
                                                    ...
                                                    <a class='btn btn-sm btn-primary' href='{{ route('faqs.index') }}'
                            ...
                            <div id="pagination_data">
                                @include('faqs.index-pagination', ['faqs' => $faqs, 'faqs' => $faqs])
                            </div>
            ...
            <div class="modal-dialog modal-dialog-centered mw-900px">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body py-lg-10 px-lg-10">
                        <form class="add-new-modal" id="kt_modal_new_form">
                            ...
                            <div class="w-100">
                                ...
                                <div class="fv-row mb-10 fv-plugins-icon-container">
                                    ...
                                    <select data-control="select2" required data-dropdown-parent="#kt_modal_new_form"
                                        ...
                                        class="form-select form-select-solid form-select-lg fw-semibold" name="type"
                                        id="type">
                            ...
                            <div class="fv-row mb-10 fv-plugins-icon-container">
                                ...
                                <select data-control="select2" required data-dropdown-parent="#kt_modal_new_form"
                                    ...
                                    class="form-select form-select-solid form-select-lg fw-semibold" name="category_id"
                                    id="category_id">
                        ...
                        @endforeach --}}
                            ...
                            <div class="fv-row mb-10 fv-plugins-icon-container" id="answer">
                                <!--begin::Label-->
                                <label class="d-flex align-items-center fs-5 fw-semibold mb-2">
