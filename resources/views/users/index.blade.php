      ...
      <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
          ...
          <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
              <li class="breadcrumb-item text-muted">
                  <a href="{{route('categories.index')}}" class="text-muted text-hover-primary">User</a>
              </li>
          ...
          <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
            ...
            <div id="kt_datatable_example_export_menu" data-kt-menu="true" class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4" style="">
              ...
              <div class="menu-item px-3">
                  <form id="user_excel_form" method="POST" action="{{route('user.excel.export')}}">
                      @csrf
              ...
              <!--begin::Menu item-->
              <div class="menu-item px-3">
                  <form id="user_csv_form" method="POST" action="{{route('user.csv.export')}}">
                      @csrf
              ...
              <!--begin::Menu item-->
              <div class="menu-item px-3">
                  <form id="user_pdf_form" method="POST" action="{{route('user.pdf.export')}}">
                      @csrf
    ...
    <div class="row g-5 g-xl-8">
      <div class="col-xl-12">
        <div class="card card-xl-stretch mb-xl-8">
          ...
          <td>
            <a class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" href="{{ route('users.show',$user->id) }}"><i class="fa fa-eye" aria-hidden="true"></i></a>
            <a class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" href="{{ route('users.edit',$user->id) }}"><i class="fas fa-pen-nib"></i></a>
