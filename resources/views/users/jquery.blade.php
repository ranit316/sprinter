<script>
    ...
    document.getElementById('answare').style.display = 'none';
    document.getElementById('category_id').addEventListener('change', function() {
        var feedback = document.getElementById('category_id').value;
        if (feedback === "Feedback") {
            document.getElementById('answare').style.display = 'none';
        } else {
            document.getElementById('answare').style.display = 'block';
        }
    });
