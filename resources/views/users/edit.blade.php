                        ...
                        <div class="card-body">
                          ...
                          <div class="w-100">
                             <div class="fv-row mb-10 fv-plugins-icon-container">
                                 ...
                                 <input type="text"   class="form-control form-control-lg form-control-solid" name="name" value="{{$user->name}}" id="name" placeholder="Name" maxlength="250" >
                                 <!--end::Input-->
                                 @error('name')
                             ...
                             <div class="fv-row mb-10 fv-plugins-icon-container">
                                 ...
                                 <!--end::Label-->
                                 <!--begin::Input-->
                                 <input type="email" class="form-control form-control-lg form-control-solid" name="email" value="{{$user->email}}" id="email" placeholder="Email" maxlength="250" >
                                 <!--end::Input-->
                                 @error('email')
                                 <span class="text-danger">{{ $message }}</span>
                                 @enderror
                            ...
                            <div class="fv-row mb-10 fv-plugins-icon-container">
                                ...
                                <select class="form-select" data-control="select2" data-placeholder="Select an option" name="roles" id="roles">
                            ...
                            {{-- <div class="fv-row mb-10 fv-plugins-icon-container">
                                ...
                                <input type="password" class="form-control form-control-lg form-control-solid" name="password" value="{{$user->password}}" id="password" placeholder="Password" maxlength="250" >
                                @error('password')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                                <div id="description_error" class="fv-plugins-message-container error_msg fv-plugins-message-container--enabled invalid-feedback"></div>
                             ...
                             <div class="fv-row mb-10 fv-plugins-icon-container" style="text-align: center">
                                 <button type="submit" id="modal_add" class="btn btn-primary">Update User</button>
