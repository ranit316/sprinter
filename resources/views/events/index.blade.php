                        ...
                        <!--begin::Menu-->
                            <div id="kt_datatable_example_export_menu" data-kt-menu="true" class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4" style="">
                                ...
                                <div class="menu-item px-3">
                                    <form id="event_excel_form" method="POST" action="{{route('event.excel.export')}}">
                                        @csrf
                                    ...
                                    <a href="javascript:void(0);" onClick="submit_form('event_excel_form','all_ids_excell','excel_type');" class="menu-link px-3" data-kt-export="excel">
                                         Excel 
                                    </a>
                                    </td></tr></table>
                                    </form>
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <form id="event_csv_form" method="POST" action="{{route('event.csv.export')}}">
                                        @csrf
                                    ...
                                    <a href="javascript:void(0);" onClick="submit_form('event_csv_form','all_ids_csv','csv_type');" class="menu-link px-3" data-kt-export="csv">
                                         CSV 
                                    </a>
                                    </td></tr></table>
                                    </form>
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <form id="event_pdf_form" method="POST" action="{{route('event.pdf.export')}}">
                                        @csrf
                                    ...
                                    <a href="javascript:void(0);" onClick="submit_form('event_pdf_form','all_ids_pdf','pdf_type');" class="menu-link px-3" data-kt-export="pdf">
                                         PDF 
                                    </a>
                                    </td></tr></table>
                                    </form>
                        ...
                        <div class="card card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bold fs-3 mb-1">Events</span>
                                        ...
                                        <div class="px-7 py-5">
                                            <form id="searchform" name="searchform">
                                                ...
                                                <div class="d-flex justify-content-end">
                                                    ...
                                                    <a class='btn btn-sm btn-primary' href='{{ route('events.index') }}' id='search_btn'>Search</a>
                            ...
                            <div id="pagination_data">
                                @include('events.index-pagination', ['events' => $events,'events'=>$events])
                            </div>
                ...
                <form class="add-new-modal" id="kt_modal_new_form"  enctype="multipart/form-data" >
                    ...
                    <div class="w-100">
                     ...
                     <div class="fv-row mb-10 fv-plugins-icon-container">
                         ...
                         <!--end::Input-->
                     <div  id="name_error" class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                    </div>
                     <div class="fv-row mb-10 fv-plugins-icon-container">
                         <!--begin::Label-->
                         <label class="d-flex align-items-center fs-5 fw-semibold mb-2">
                         ...
                         <!--end::Label-->
                         <!--begin::Input-->
                         <select data-control="select2" required data-dropdown-parent="#kt_modal_new_form" data-placeholder="Select a category..." class="form-select form-select-solid form-select-lg fw-semibold"     name="category_id" id="category_id" >
                     ...
                     <div class="fv-row mb-10 fv-plugins-icon-container">
                        ...
                        <!--begin::Input-->
                         <select data-control="select2" required data-dropdown-parent="#kt_modal_new_form"
                            ...
                            <option value="WA" selected>WhatApp Number</option>
