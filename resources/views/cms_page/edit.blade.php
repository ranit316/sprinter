                ...
                <div class="col-xl-12">
                    ...
                    <div class="card card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-header">
                            <h3 class="card-title">Edit Page Links</h3>
                        ...
                        <div class="card-body">
                            ...
                            {!! Form::model($page, ['method' => 'PATCH','route' => ['cms_pages.update', $page->id]]) !!}
                            ...
                            <div class="w-100">
                             <div class="fv-row mb-10 fv-plugins-icon-container">
                                 ...
                                 <input type="text"   class="form-control form-control-lg form-control-solid" name="name" value="{{$page->title}}" id="name" placeholder="Title" maxlength="250" >
                                 <!--end::Input-->
                                 @error('name')
                             ...
                             <div class="fv-row mb-10 fv-plugins-icon-container">
                                 ...
                                 <!--end::Label-->
                                 <!--begin::Input-->
                                 <input type="url" class="form-control form-control-lg form-control-solid" name="description" id="description" placeholder="link" value="{{strip_tags($page->description)}}" >
                                 <!--end::Input-->
                                 @error('description')
                                 <span class="text-danger">{{ $message }}</span>
                                 @enderror
                             ...
                             <div class="fv-row mb-10 fv-plugins-icon-container" style="text-align: center">
                                 <button type="submit" id="modal_add" class="btn btn-primary">Update Page Links</button>
