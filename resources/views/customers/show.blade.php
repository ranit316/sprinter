                        ...
                        <div class="card-body">
                          ...
                          <div class="col-6">
                             <div class="fv-row mb-10 fv-plugins-icon-container">
                                 ...
                                 <div class="bg-light-success py-2 px-2">{{$customer->first_name . ' ' . $customer->last_name }}</div>
                            </div>
                          </div>
                          ...
                          <div class ="col-6">
                             <div class="fv-row mb-10 fv-plugins-icon-container">
                                 ...
                                 <div class="bg-light-success py-2 px-2">{{$customer->address}}</div>                      
                            </div>
                          </div>
                          ...
                          <div class ="col-6">
                            <div class="fv-row mb-10 fv-plugins-icon-container">
                                ...
                                <div class="bg-light-success py-2 px-2">{{$customer->phone_number}}</div>                      
                           </div>
                         </div>
                          ...
                          <div class="col-6">  
                             <div class="fv-row mb-10 fv-plugins-icon-container">
                                ...
                                <div class="bg-light-success py-2 px-2">{{$customer->status}}</div>
                             </div>
                          </div>      
