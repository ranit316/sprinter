                        ...
                        <div class="card-body">
                          ...
                          <div class="col-6">
                             <div class="fv-row mb-10 fv-plugins-icon-container">
                                 ...
                                 <div class="bg-light-success py-2 px-2">{{$review->type}}</div>
                            </div>
                          </div>
                          ...
                          <div class ="col-6">
                             <div class="fv-row mb-10 fv-plugins-icon-container">
                                 ...
                                 <div class="bg-light-success py-2 px-2">{{strip_tags($review->content)}}</div>                      
                            </div>
                          </div>
                          ...
                          <div class="col-6">
                            <div class="fv-row mb-10 fv-plugins-icon-container">
                                ...
                                <div class="bg-light-success py-2 px-2">{{$review->marks}}</div>
                            </div>
                         </div>
                          ...
                          <div class="col-6">  
                             <div class="fv-row mb-10 fv-plugins-icon-container">
                                ...
                                <div class="bg-light-success py-2 px-2">{{$review->status}}</div>
                             </div>
                          </div>
                             ...
                             <div class="fv-row mb-10 fv-plugins-icon-container">
                                 ...
                                 @if($review->photo!='')
                                 <img src="{{asset($review->photo)}}" width="150" />
                                 @endif
                                 <!--end::Input-->
