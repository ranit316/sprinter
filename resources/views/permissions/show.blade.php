            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="{{route('roles.index')}}" class="text-muted text-hover-primary">Permission</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                        ...
                        <div class="card-body">
                          ...
                          <div class="w-100">
                             ...
                             <div class="fv-row mb-10 fv-plugins-icon-container">  
                                 ...
                                 <input type="text" class="form-control form-control-lg form-control-solid" name="name" value="{{$permission->name}}" id="name" placeholder="Name" maxlength="250" readonly>
                                 <!--end::Input-->                             
                             </div>
