            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="{{route('faq_category.index')}}" class="text-muted text-hover-primary">Category</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                ...
                <div class="col-xl-12">
                    ...
                    <div class="card card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            {!! Form::model($category, ['method' => 'PATCH','enctype'=>'multipart/form-data','route' => ['faq_category.update', $category->id]]) !!}
