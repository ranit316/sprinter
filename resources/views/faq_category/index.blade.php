        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">FAQ Category</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            <a href="{{route('faq_category.index')}}" class="text-muted text-hover-primary">FAQ Category</a>
                        </li>
                        <!--end::Item-->
                        <!--begin::Item-->
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                        ...
                        <button type="button"  class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modals-add">
                            <span class="fa fa-plus"></span> Add FAQ Category		
                        </button>
                        ...
                        <!--begin::Menu-->
                            <div id="kt_datatable_example_export_menu" data-kt-menu="true" class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4" style="">
                                ...
                                <div class="menu-item px-3">
                                    <form id="category_excel_form" method="POST" action="{{route('faq_category.excel.export')}}">
                                        @csrf
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <form id="category_csv_form" method="POST" action="{{route('faq_category.csv.export')}}">
                                        @csrf
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <form id="category_pdf_form" method="POST" action="{{route('faq_category.pdf.export')}}">
                                        @csrf
                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="card card-xl-stretch mb-xl-8">
                                        ...
                                        <div class="px-7 py-5">
                                            <form id="searchform" name="searchform">
                                                ...
                                                <div class="d-flex justify-content-end">
                                                    ...
                                                    <a class='btn btn-sm btn-primary' href='{{ route('faq_category.index') }}' id='search_btn'>Search</a>
                            ...
                            <div id="pagination_data">
                                @include('faq_category.index-pagination', ['categories' => $categories])
                            </div>
