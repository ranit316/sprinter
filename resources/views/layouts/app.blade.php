...
<head>
    ...
    ?>
    <title>{{ $appinfo->title != '' ? $appinfo->title : 'Laravel' }}</title>
    ...
    <link rel="shortcut icon"
        href="{{ $appinfo->fav_icon != '' ? asset($appinfo->fav_icon) : asset('assets/media/logos/favicon.ico') }}" />
...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
    ...
    <script src="{{ URL::asset('backend/jquery/jquery/jquery.min.js') }}"></script>

    <!-- jQuery UI 1.11.4 -->

    <script src="{{ URL::asset('backend/jquery/jquery-ui/jquery-ui.min.js') }}"></script>
...
<script>
    ...
    $(document).on("click", "#pagination a,#search_btn", function(event) {
        ...
        $("#pagination_data").html('<center><img src="' + baseurl +
            '/images/loadingpleasewait.gif" width="80" /></center>');
...
<?php
    if(Route::currentRouteName()=='categories.index')
     {
     ?>
@include('categories.jquery')
<?php

    }
     ?>
<?php
    if(Route::currentRouteName()=='faq_category.index')
     {
     ?>
@include('faq_category.jquery')
<?php

    }
     ?>
<?php
    if(Route::currentRouteName()=='platforms.index')
     {
     ?>
@include('platforms.jquery')
<?php

    }
     ?>
<?php
    if(Route::currentRouteName()=='contests.index')
     {
     ?>
<script src="{{ asset('assets/plugins/custom/ckeditor/ckeditor-classic.bundle.js') }}"></script>
@include('contests.jquery')
<?php
...
<?php
    if(Route::currentRouteName()=='events.index' || Route::currentRouteName()=='events.edit')
     {
     ?>
<script src="{{ asset('assets/plugins/custom/ckeditor/ckeditor-classic.bundle.js') }}"></script>
@include('events.jquery')
<?php
...
<?php
    if(Route::currentRouteName()=='offers.index' || Route::currentRouteName()=='offers.edit')
     {
     ?>
<script src="{{ asset('assets/plugins/custom/ckeditor/ckeditor-classic.bundle.js') }}"></script>
@include('offers.jquery')
<?php
...
<?php
    if(Route::currentRouteName()=='customers.index')
     ...
     ?>
<script src="{{ asset('assets/plugins/custom/ckeditor/ckeditor-classic.bundle.js') }}"></script>
@include('customers.jquery')
<?php

    }
     ?>
<?php
    if(Route::currentRouteName()=='reviews.index')
     {
     ?>
@include('reviews.jquery')
<?php
