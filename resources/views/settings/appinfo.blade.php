        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">APP
                        Info
                    </h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="#" class="text-muted text-hover-primary">APP Info</a>
                        </li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        ...
                        <div class="card mb-5 mb-xl-10">
                            ...
                            <div id="kt_account_settings_profile_details" class="collapse show">
                                ...
                                <form id="kt_account_profile_details_form" class="form"
                                    action="{{ route('appinfo.update') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <!--begin::Card body-->
                                    <div class="card-body border-top p-9">
                                        ...
                                        <div class="row mb-6">
                                            <!--begin::Label-->
                                            <label class="col-lg-4 col-form-label  fw-semibold fs-6">Footer left</label>
                                            <!--end::Label-->
                                            <!--begin::Col-->
                                            <div class="col-lg-8">
                                                <!--begin::Row-->
                                        ...
                                        <div class="row mb-6">
                                            <!--begin::Label-->
                                            <label class="col-lg-4 col-form-label  fw-semibold fs-6">Cc</label>
                                            <!--end::Label-->
                                            <!--begin::Col-->
                                            <div class="col-lg-8">
                                                <!--begin::Row-->
                                        ...
                                        <div class="row mb-6">
                                            <!--begin::Label-->
                                            <label class="col-lg-4 col-form-label  fw-semibold fs-6">Bcc</label>
                                            <!--end::Label-->
                                            <!--begin::Col-->
                                            <div class="col-lg-8">
                                                <!--begin::Row-->
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12 fv-row">
                                                        <input type="email" name="email"
                                                            class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                            placeholder="Email" value="{{ $appinfo->email }}" />
                                                    </div>
                                                    <!--end::Col-->
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12 fv-row">
                                                        <input type="number" name="phone"
                                                            class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                            placeholder="Phone" value="{{ $appinfo->phone }}" />
                                                    </div>
                                                    <!--end::Col-->
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12 fv-row">
                                                        ...
                                                        <input type="number" name="whats_app_1"
                                                            class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                            placeholder="Whatsapp No 1" value="{{ $appinfo->whats_app_1 }}" />
                                                    </div>
                                                    <div class="col-lg-12 fv-row">
                                                        <label class="col-lg-4 col-form-label  fw-semibold fs-6">Whatsapp No 2</label>
                                                        <input type="number" name="whats_app_2"
                                                            class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                            placeholder="Whatsapp No 2" value="{{ $appinfo->whats_app_2 }}" />
                                                    </div>
                                                    <div class="col-lg-12 fv-row">
                                                        <label class="col-lg-4 col-form-label  fw-semibold fs-6">Whatsapp No 3</label>
                                                        <input type="number" name="whats_app_3"
                                                            class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                            placeholder="Whatsapp No 3" value="{{ $appinfo->whats_app_3 }}" />
                                                    </div>
                                                    <div class="col-lg-12 fv-row">
                                                        <label class="col-lg-4 col-form-label  fw-semibold fs-6">Whatsapp No 4</label>
                                                        <input type="number" name="whats_app_4"
                                                            class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                            placeholder="Whatsapp No 4" value="{{ $appinfo->whats_app_4 }}" />
                                                    </div>
                                                    <div class="col-lg-12 fv-row">
                                                        <label class="col-lg-4 col-form-label  fw-semibold fs-6">Whatsapp No 5</label>
                                                        <input type="number" name="whats_app_5"
                                                            class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                            placeholder="Whatsapp No 5" value="{{ $appinfo->whats_app_5 }}" />
                                                    </div>
                                                    <div class="col-lg-12 fv-row">
                                                        <label class="col-lg-4 col-form-label  fw-semibold fs-6">Whatsapp No 6</label>
                                                        <input type="number" name="whats_app_6"
                                                            class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                                            placeholder="Whatsapp No 6" value="{{ $appinfo->whats_app_6 }}" />
                                                    </div>
                                                    <!--end::Col-->
