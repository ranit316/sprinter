    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Offer</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">
                        <a href="{{route('offers.index')}}" class="text-muted text-hover-primary">Offer</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                    ...
                    <a href="{{route('offers.index')}}" type="button"  class="btn btn-primary" >
                ...
                <div class="col-xl-12">
                    ...
                    <div class="card card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            {!! Form::model($offer, ['method' => 'PATCH','enctype'=>'multipart/form-data','route' => ['offers.update', $offer->id]]) !!}
                            ...
                            <div class="w-100">
                             ...
                             <div class="fv-row mb-10 fv-plugins-icon-container">
                                 ...
                                 <input type="text" class="form-control form-control-lg form-control-solid" name="name" value="{{$offer->name}}" id="name" placeholder="Name" maxlength="250" >
                                 <!--end::Input-->
                                 @error('name')
                             ...
                             <div class="fv-row mb-10 fv-plugins-icon-container">
                                 ...
                                 <!--end::Label-->
                                 <!--begin::Input-->
                                 <textarea class="form-control form-control-lg form-control-solid" name="description" id="description" placeholder="Description"  >{{$offer->description}}</textarea>
                                 <!--end::Input-->
                                 @error('description')
                                 <span class="text-danger">{{ $message }}</span>
                                 @enderror
                            ...
                            <div class="fv-row mb-10 fv-plugins-icon-container">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <select required class="form-control form-control-lg form-control-solid" name="feature" id="feature" >
                                    <option value="Yes" {{($offer->is_feature=='Yes')?'selected':''}}>Yes</option>
                                    <option value="No" {{($offer->is_feature=='No')?'selected':''}}>No</option>
                                </select>
                                <!--end::Input-->
                              <div id="description_error" class="fv-plugins-message-container error_msg fv-plugins-message-container--enabled invalid-feedback"></div>
                             </div>
                             ...
                             <div class="fv-row mb-10 fv-plugins-icon-container">
                                 ...
                                 <img src="{{asset($offer->photo)}}" width="150" />
                                 @endif
                                 <!--end::Input-->
                             ...
                             <div class="fv-row mb-10 fv-plugins-icon-container" style="text-align: center">
                                 <button type="submit" id="modal_add" class="btn btn-primary">Update Offer</button>
