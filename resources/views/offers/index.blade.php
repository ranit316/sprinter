        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Offers</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                        ...
                        <button type="button"  class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modals-add">
                            <span class="fa fa-plus"></span> Add Offer		
                        </button>
                        ...
                        <!--begin::Menu-->
                            <div id="kt_datatable_example_export_menu" data-kt-menu="true" class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4" style="">
                                ...
                                <div class="menu-item px-3">
                                    <form id="offer_excel_form" method="POST" action="{{route('offer.excel.export')}}">
                                        @csrf
                                    ...
                                    <a href="javascript:void(0);" onClick="submit_form('offer_excel_form','all_ids_excell','excel_type');" class="menu-link px-3" data-kt-export="excel">
                                         Excel 
                                    </a>
                                    </td></tr></table>
                                    </form>
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <form id="offer_csv_form" method="POST" action="{{route('offer.csv.export')}}">
                                        @csrf
                                    ...
                                    <a href="javascript:void(0);" onClick="submit_form('offer_csv_form','all_ids_csv','csv_type');" class="menu-link px-3" data-kt-export="csv">
                                         CSV 
                                    </a>
                                    </td></tr></table>
                                    </form>
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <form id="offer_pdf_form" method="POST" action="{{route('offer.pdf.export')}}">
                                        @csrf
                                    ...
                                    <a href="javascript:void(0);" onClick="submit_form('offer_pdf_form','all_ids_pdf','pdf_type');" class="menu-link px-3" data-kt-export="pdf">
                                         PDF 
                                    </a>
                                    </td></tr></table>
                                    </form>
                        ...
                        <div class="card card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bold fs-3 mb-1">Offers</span>
                                        ...
                                        <div class="px-7 py-5">
                                            <form id="searchform" name="searchform">
                                                ...
                                                <div class="d-flex justify-content-end">
                                                    ...
                                                    <a class='btn btn-sm btn-primary' href='{{ route('offers.index') }}' id='search_btn'>Search</a>
                            ...
                            <div id="pagination_data">
                                @include('offers.index-pagination', ['offers' => $offers])
                            </div>
                ...
                <form class="add-new-modal" id="kt_modal_new_form"  enctype="multipart/form-data" >
                    ...
                    <div class="w-100">
                     ...
                     <div class="fv-row mb-10 fv-plugins-icon-container">
                         ...
                         <!--end::Label-->
                         <!--begin::Input-->
                         <input type="text" required class="form-control form-control-lg error_msg form-control-solid" name="name" id="name" placeholder="Name" maxlength="250" >
                         <!--end::Input-->
                     <div  id="name_error" class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div></div>
                     <div class="fv-row mb-10 fv-plugins-icon-container">
                         <!--begin::Label-->
                         <label class="d-flex align-items-center fs-5 fw-semibold mb-2">
                             <span class="required">Featured</span>
                             <span class="ms-1" data-bs-toggle="tooltip" aria-label="Specify your unique app name" data-bs-original-title="Specify your unique app name" data-kt-initialized="1">
                                 <i class="ki-duotone ki-information-5 text-gray-500 fs-6">
                                     <span class="path1"></span>
                                     <span class="path2"></span>
                         ...
                         <!--end::Label-->
                         <!--begin::Input-->
                         <select data-control="select2" required data-dropdown-parent="#kt_modal_new_form" data-placeholder="Select option..." class="form-select form-select-solid form-select-lg fw-semibold"     name="is_feature" id="is_feature" >
                         ...
                         <!--end::Input-->
                     <div  id="is_feature_error" class="fv-plugins-message-container error_msg fv-plugins-message-container--enabled invalid-feedback"></div></div>
                     ...
                     <div class="fv-row mb-10 fv-plugins-icon-container">
                         ...
                         <!--end::Label-->
                         <!--begin::Input-->
                         <input class="form-control form-control-solid" required placeholder="Pick date rage" id="kt_daterangepicker_4" name="start_end_date"/>
                           <!--end::Input-->
                     <div  class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                    </div>
                            ...
                            class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                             ...
                             <div class="fv-row mb-10 fv-plugins-icon-container" style="display:none;" id="Link_div">
                                ...
                                <div class="fv-row mb-10 fv-plugins-icon-container" style="display:none;" id="Tel_div">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text"  class="form-control form-control-lg error_msg form-control-solid" name="cta_tel" id="cta_tel" value=""
                                        placeholder="Tel" />
                                    <!--end::Input-->
                                ...
                                <div class="fv-row mb-10 fv-plugins-icon-container" style="display:block;" id="WA_div">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text"  class="form-control form-control-lg error_msg form-control-solid" name="cta_wa" id="cta_wa" value="{{$wa}}"
                     ...
                     <div class="fv-row mb-10 fv-plugins-icon-container">
                         ...
                         <input type="file" class="form-control form-control-lg error_msg form-control-solid" onchange="readURL(this,'blah_2');" name="photo" id="file" accept=".jpg, .jpeg, .png"  />
