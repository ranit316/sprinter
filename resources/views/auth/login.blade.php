                        ...
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form"
                            ...
                            <div class="text-center mb-11">
                                <div style="width: 200px; margin: auto;">
                                    <img src="{{asset('assets/media/logos/custom-4.png')}}" class="img-fluid">
                                </div>
                                <!--begin::Title-->
                            ...
                            {{-- <div class="fw-semibold text-primary fs-base gap-5 text-end"><a>Forget Password<i class="fa fa-question" aria-hidden="true"></i></i></a></div> --}}
                            <!--end::Input group=-->
                            <!--begin::Wrapper-->
            ...
            <div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2"
                ...
                <div class="d-flex flex-column flex-center py-7 py-lg-15 px-5 px-md-15 w-100">
                    ...
                    <a href="" class="mb-0 mb-lg-12">
                        <img alt="Logo"
                            src="{{ $appinfo->logo != '' ? asset($appinfo->logo) : asset('assets/media/logos/custom-4.png') }}"
                    ...
                    <!--end::Image-->
                    <!--begin::Title-->
                    <h1 class="d-none d-lg-block text-white fs-2qx fw-bolder text-center mb-7">SPRINTER ONLINE
                        </h1>
                    <!--end::Title-->
                    <!--begin::Text-->
                    <div class="d-none d-lg-block text-white fs-base text-center">#1 MOST TRENDING ONLINE GAMEING,
...
<div class="container">
    <div class="row justify-content-center py-5">
        ...
        <div class="col-6"> 
            <div class="text-center fw-semibold text-primary fs-base">
                <a href="#" target="_blank">{{optional(DB::table('app_infos')->first())->footer_left}} </a>
            </div>
        </div>
        <div class="col-6"> 
        ...
        <div class="d-flex fw-semibold text-primary fs-base gap-5">
            ...
            @if ($data->title != 'Unsubscibe')
               <a href="{{$data->description}}" target="_blank">{{$data->title}}</a>
            @endif
            @endforeach
