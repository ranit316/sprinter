                        ...
                        <div class="card-body">
                          ...
                          <div class="w-100">
                             ...
                             <div class="fv-row mb-10 fv-plugins-icon-container">  
                                 ...
                                 <input type="text" class="form-control form-control-lg form-control-solid" name="name" value="{{$role->name}}" id="name" placeholder="Name" maxlength="250" readonly>
                                 <!--end::Input-->                             
                             </div>
                             ...
                             <div class="fv-row mb-10 fv-plugins-icon-container">
                                <label class="d-flex align-items-center fs-5 fw-semibold mb-2">
                                    ...
                                    <div class="form-check form-check-custom form-check-success form-check-solid my-4 mx-2">
                                        <input class="form-check-input" type="checkbox" name="permission[]" value="{{$permissions->name }}" checked/>
