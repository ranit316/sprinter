                        ...
                        <div class="card-body">
                          ...
                          <div class="w-100">
                             ...
                             <div class="fv-row mb-10 fv-plugins-icon-container">
                                 ...
                                 <input type="text"   class="form-control form-control-lg form-control-solid" name="name" value="{{$role->name}}" id="name" placeholder="Role Name" maxlength="250" >
                                 <!--end::Input-->
                                 @error('name')
                             ...
                             <div class="fv-row mb-10 fv-plugins-icon-container">
                                ...
                                <!--begin::Input-->
                                    ...
                                    <div class="form-check form-check-custom form-check-success form-check-solid my-4 mx-2">
                                        <input id="p_{{$permissions->name }}" class="form-check-input" type="checkbox" name="permission[]" value="{{$permissions->name }}"
                                        <?php if(in_array($permissions->id, $rolePermissions)){echo "checked";} ?> />
                                        <label class="form-check-label" for="p_{{$permissions->name }}"> {{$permissions->name }}  </label>
                                    </div>
                                    @endforeach
                            ...
                            <div id="description_error" class="fv-plugins-message-container error_msg fv-plugins-message-container--enabled invalid-feedback"></div>
                             ...
                             <div class="fv-row mb-10 fv-plugins-icon-container" style="text-align: center">
                                 <button type="submit" id="modal_add" class="btn btn-primary">Update Role</button>
                             </div>
