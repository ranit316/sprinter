      ...
      <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
          ...
          <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
              <li class="breadcrumb-item text-muted">
                  <a href="{{route('categories.index')}}" class="text-muted text-hover-primary">Role</a>
              </li>
          ...
          <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
            ...
            <div id="kt_datatable_example_export_menu" data-kt-menu="true" class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4" style="">
              ...
              <div class="menu-item px-3">
                  <form id="user_excel_form" method="POST" action="{{route('role.excel.export')}}">
                      @csrf
                      ...
                      <a href="javascript:void(0);" onClick="submit_form('user_excel_form','all_ids_excell','excel_type');" class="menu-link px-3" data-kt-export="excel">
                       Excel 
                  </a>
                  </td></tr>
                  </table>
              ...
              <!--begin::Menu item-->
              <div class="menu-item px-3">
                  <form id="user_csv_form" method="POST" action="{{route('role.csv.export')}}">
                      @csrf
                  ...
                  <a href="javascript:void(0);" onClick="submit_form('user_csv_form','all_ids_csv','csv_type');" class="menu-link px-3" data-kt-export="csv">
                       CSV 
                  </a>
                  </td></tr></table>
                  </form>
              ...
              <!--begin::Menu item-->
              <div class="menu-item px-3">
                  <form id="user_pdf_form" method="POST" action="{{route('role.pdf.export')}}">
                      @csrf
                  ...
                  <a href="javascript:void(0);" onClick="submit_form('user_pdf_form','all_ids_pdf','pdf_type');" class="menu-link px-3" data-kt-export="pdf">
                       PDF 
                  </a>
                  </td></tr></table>
                  </form>
        ...
        <div class="card card-xl-stretch mb-xl-8">
          <div class="card-header border-0 pt-5">
            ...
            <h3 class="card-title align-items-start flex-column">
              <span class="card-label fw-bold fs-3 mb-1">Role</span>
            ...
            <div class="card-body card-toolbar">
              <table class="table table-row-bordered gy-3">
                ...
                <tr>
                  ...
                  <td>{{ $role->name }}</td>
          <td>
            <a class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" href="{{ route('roles.show',$role->id) }}"><i class="fa fa-eye" aria-hidden="true"></i></a>
            <a class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" href="{{ route('roles.edit',$role->id) }}"><i class="fas fa-pen-nib"></i></a>
